const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: 'Welcome to DigitalMall', url: 'https://www.iformore.shop' },
    { title: 'If you have any requirement just let me know', url: 'https://www.iformore.shop' }
  ],
  ...
  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: 'Recommend', url: '/tag/Recommend' },
  HERO_CATEGORY_2: { title: 'Hot Sales', url: '/tag/Hot' },
  ...
  INFO_CARD_URL: 'https://www.iformore.shop', // 个人资料底部按钮链接
