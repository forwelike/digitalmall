...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'DigitalMall', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Share the great digital works', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.iformore.shop', // 网站地址
